...
* **Rule: Silence is not the same as a source you would rather not have.** The rule above governs *inference*. It does not license hedging against a named, authoritative human who has said something plainly. **A product owner announcing their own product is a primary source**, and documentation frequently lags a launch by days. When an executive states GA and the changelog has not caught up, the announcement is the fact and the changelog is the backlog: report it that way, attribute it to the person, and note where the docs stand. Applying "write the silence" to a signed public statement is not rigor, it is second-guessing someone with more standing than we have. **Be skeptical of what we infer; be accurate about what someone with authority asserted.**
